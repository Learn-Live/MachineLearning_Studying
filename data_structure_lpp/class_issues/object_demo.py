r"""
    # https://amir.rachum.com/blog/2016/10/03/understanding-python-class_issues-instantiation/
    ...
    So Foo(1, y=2) is equivalent to Foo.__call__(1, y=2). That __call__ is the one defined by Foo’s class_issues. What is Foo’s class_issues?
"""


# If we ignore error checking for a minute, then for regular class_issues instantiation this is roughly equivalent to:
